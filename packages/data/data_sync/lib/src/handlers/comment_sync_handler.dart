...
/// Syncs comments to the Plane API.
class CommentSyncHandler extends EntitySyncHandler {
  CommentSyncHandler({required PlaneApiClient apiClient})
      : _api = apiClient;
  ...
  FutureVoid syncCreate(Map<String, dynamic> payload) async {
    try {
      ...
      final workItemId = payload['workItemId'] as String;
  ...
  FutureVoid syncUpdate(Map<String, dynamic> payload) async {
    try {
      ...
      final projectId = payload['projectId'] as String;
      final workItemId = payload['workItemId'] as String;
      final commentId = payload['entityId'] as String;
